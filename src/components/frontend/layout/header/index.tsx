...
export function Header() {
  ...
  const { isHeaderTransparent, isScrolled, scrollPercent, isFooterVisible } = useHeader(isPostDetailPage || false);
        ...
        >
          <div className={styles.headerContent}>
            ...
            <div className={styles.headerLeft}>
              {/* 快捷菜单按钮 - 桌面端显示 */}
              {navConfig?.menu && navConfig.menu.length > 0 && !isMobile && (
                <div className={styles.backHomeButton}>{/* TODO: BackMenuListGroups 组件 */}</div>
              )}
