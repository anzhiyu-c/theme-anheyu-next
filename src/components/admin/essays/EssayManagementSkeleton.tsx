...
export function EssayManagementSkeleton() {
  return (
    <div className="h-full flex flex-col overflow-hidden -m-4 lg:-m-8 animate-pulse">
      <div className="flex-1 min-h-0 flex flex-col mx-6 mt-5 mb-2 bg-card border border-border/60 rounded-xl overflow-hidden">
        ...
        <div className="shrink-0 px-5 pt-4 pb-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="h-8 w-16 bg-muted/30 rounded-lg" />
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 px-3">
          <div className="h-10 bg-muted/10 rounded-lg mb-1.5" />
          {Array.from({ length: 8 }).map((_, i) => (
            <div key={i} className="flex items-center gap-4 px-3 py-3 mb-1.5 rounded-xl bg-muted/5">
              ...
              <div className="w-24 h-7 bg-muted/15 rounded" />
            </div>
          ))}
        </div>
